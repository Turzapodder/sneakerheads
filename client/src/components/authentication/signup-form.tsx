...
export function SignupForm({
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // Create user with Clerk including first and last name
  ...
  const handleOAuthSignup = async (provider: "oauth_google" | "oauth_apple" | "oauth_facebook") => {
    if (!isLoaded) return;
          ...
          <form className="p-6 md:p-8" onSubmit={handleSignup}>
            <FieldGroup>
              ...
              <FieldDescription className="text-center">
                Already have an account? <a href="/signin" className="underline underline-offset-4 hover:text-primary">Sign in</a>
              </FieldDescription>
            </FieldGroup>
          </form>
